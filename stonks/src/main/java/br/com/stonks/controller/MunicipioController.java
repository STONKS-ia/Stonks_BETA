...
import br.com.stonks.repository.MunicipioRepository;
...
public class MunicipioController {
	...
	public String openForm(@RequestParam String page, 
		...
		if ("municipio-editar".equals(page)) {
	...
	@PostMapping
	public String save( MunicipioModel municipioModel,  RedirectAttributes redirectAttributes){
	...
	@PutMapping("/{id}")
	public String update(@PathVariable("id") int id, MunicipioModel municipioModel, RedirectAttributes redirectAttributes) {
